...
### `script.js`
#### *คืออะไร:*
*   ไฟล์ JavaScript ที่ดูเหมือนจะเป็นเวอร์ชันเก่าของ `app.js`

#### *ทำอะไร:*
*   ในปัจจุบัน ไฟล์นี้ไม่ได้ถูกเรียกใช้งานโดย `index.html` จึงไม่มีผลต่อการทำงานของแอปพลิเคชัน สามารถลบออกได้เพื่อลดความสับสน
...
#
1. ฉันอยากเพิ่มตัวนับ จำนวนว่าฉันได้ทำไปกี่ข้อแล้วจาก จำนวนข้อที่ฉันเลือก เช่น เลือก 10 ข้อ และทำบททดสอบไปแล้ว 1 ข้อ ให้แสดง 1/10 มุมขวา บรรทัดเดียวกับ typingFeedback แสดงในทุก Mode ที่เลือกใช้งาน 

2. ถ้าตอบผิดในทุก Mode ให้แสดงข้อความ 0 พร้อม animation ระเบิดกลางหน้าจอ และหายไป พร้อมที่จะทำข้อถัดไป 

3. Language Master ฉันอยากให้เปลี่ยนเป็นชื่อ Mode ที่เลือกแทน ถ้าเลือก Mode ไหนให้แสดงชื่อ Mode นั้น

นายอ่านโค้ดจากทุกไฟล์ของฉันและแก้ไขตามที่ฉันต้องการในจุดที่จำเป็นต้องแก้ไข โดยไม่เขียนทับ หรือเขียนเพิ่มสิ่งที่นอกเหนือจากที่ฉันต้องการ และฟังก์ชั่นที่ทำงานได้อยู่ในขณะนี้ ให้มันทำงานได้ต่อไปเหมือนเดิม
